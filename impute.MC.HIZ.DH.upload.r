#The aim of this script is to impute MRI phenotypes (Complications: MC, HIZ, and DH and Core: SS + binarized DB)
#The purpose of this imputation is to generate the "lifetime slope" which better explains the lifetime change of these features instead of calculating the 
#slope of features only between specific T1 and T2, for a slope in the two time points may not be representative for lifetime change. 
